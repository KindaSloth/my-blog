...
[Lexer](https://github.com/Guilherme775/Cria/blob/main/src/lexer.ts).
...
First, we define our [AST](https://github.com/Guilherme775/Cria/blob/main/src/ast.ts).

And with that, we can write our parser: [Parser](https://github.com/Guilherme775/Cria/blob/main/src/parser.ts).
...
Here you can see the basic type checker implementation that I did: [Type checker](https://github.com/Guilherme775/Cria/blob/main/src/checker.ts).
...
[Printer](https://github.com/Guilherme775/Cria/blob/main/src/printer.ts).
